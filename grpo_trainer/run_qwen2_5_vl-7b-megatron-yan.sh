...
HF_MODEL_PATH=${HF_MODEL_PATH:-"/data/Qwen2.5-VL-7B-Instruct"}
...
experiment_name=${experiment_name:-7b-mcore-vllm-n${NNODES}-${verl_version}}
...
python3 -m verl.trainer.main_ppo ${verl_args[@]} $@ | tee -a ${experiment_name}-${TURN}.log
